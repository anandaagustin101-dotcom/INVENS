                    ...
                    <form action="{{ route('barang-masuk.update', $barangmasuk->id) }}" method="POST">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text"
                                ...
                                id="nama" name="nama"
                                value="{{ old('nama') ?? $barangmasuk->databarang->nama}}" />
                            @error('nama')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text"
                                ...
                                id="kode" name="kode"
                                value="{{ old('kode', $barangmasuk->databarang->kode) }}" />
                            @error('kode')
                                <div class="invalid-feedback d-block">
                                    {{ $message }}
                                </div>
                        ...
                        {{-- Tanggal --}}
                            ...
                            <input type="date" 
                                    name="tanggal" 
                                    id="tanggal" 
                                    value="{{ old('tanggal', \Carbon\Carbon::parse($barangmasuk->databarang->tanggal)->format('Y-m-d')) }}" 
                                    class="form-control" />
                            @error('tanggal')
